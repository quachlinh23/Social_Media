      ...
      <div className="profile">
        <div className="profileTop">
          <div className="profileSub">
            <img src={user.profilePicture} alt="" className="profileSubImg" />
          </div>
          <div className="profileMain">
            {/* <div className="profileMainLeft"> */}
            <img src={user.profilePicture} alt="" className="profileMainImg" />
            {/* </div> */}
            {/* <div className="profileMainRight"> */}
            <span className="profileMainRightUserName">{user.fullname}</span>
          </div>
          {/* </div> */}
        ...
        <div className="profileBottom">
          <div className="profileBottomLeft">
            <div className="profileBottomLeftTop">
              ...
              <div className="bio">{user.desc}</div>
            </div>
