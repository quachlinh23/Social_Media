  ...
  function handleChat() {
    if (messageText !== "") {
      setMessageDisplay((pre) => [
        ...pre, // giữ lại tin nhắn cũ
        { text: messageText }, //thêm tin nhắn mới
      ]);
      setMessageText("");
    }
  }
  ...
  return (
    <div className="chatWrapper">
      <div className="chatTop">
        ...
        <div className="Info">
          <span className="InfoName">{InfoFriend.fullname}</span>
          <br />
          <span className="activeTime">Đang hoạt động</span>
        </div>
        <Remove
        ...
        {Messages.filter(
          ...
          ms.idSend === user.id ? (
            <div className="chatSend" key={ms.id}>
              <span className="chatSendText">{ms.text}</span>
            </div>
          ) : (
            <div className="chatReceive" key={ms.id}>
              ...
              <span className="chatReceiveText">{ms.text}</span>
            </div>
          )
        )}
      ...
      <div className="chatBottom">
        ...
        />
        <button className="chatSendBtn" onClick={handleChat}>
          Gửi
        </button>
      </div>
    </div>
