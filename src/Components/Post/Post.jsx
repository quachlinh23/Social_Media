        ...
        <div className="postBottom">
          <div className="postBottomTop">
            ...
            <div className="postBottomTopRight">
              <span className="postCommentText" onClick={HandleDetailPost}>
          ...
          <div className="postBottomBottom">
            <button className="postButton" onClick={LikeHandle}>
              <ThumbUp
                style={{
                  marginRight: "2px",
                  color: isLike ? "blue" : "",
            ...
            <button className="postButton" onClick={HandleDetailPost}>
